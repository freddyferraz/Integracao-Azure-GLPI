...
public sealed class UsuarioRepository(IntegracaoContext dbContext, IDbSession dbSession) : IUsuarioRepository
{
    public async ValueTask<(IEnumerable<Usuario> data, int total)> RetornaUsuarioById(long id)
    {
